...
1. Znajdź klucz dostępu. W Storage Account przejdź do `Security + networking → Access keys`
...
```python
df_clean = df[df["trip_distance"] > 0]

output_path = f"abfs://taxi-data@{account_name}.dfs.core.windows.net/silver/cleaned.parquet"
